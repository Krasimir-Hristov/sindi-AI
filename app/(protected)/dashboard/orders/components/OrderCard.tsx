        ...
        <div className="border-t border-gray-100 p-6 bg-gray-50">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-gray-600">Πληρωμένα:</span>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(item.paid_quantity / item.quantity) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  {/* Payment Actions */}
                  {item.paid_quantity < item.quantity && order.status !== 'cancelled' && (
                    <div className="flex gap-2">
                      <button
                        onClick={() =>
                          handlePaymentUpdate(item.id, item.paid_quantity + 1)
                        }
                        disabled={loading}
          ...
          {order.notes && (
            <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-200">
              <p className="text-sm font-semibold text-blue-900 mb-1">Σημειώσεις:</p>
