...
[ ] Отворете `src/app/layout.tsx` и настройте основните елементи (`<html>`, `<body>`).
[ ] Изчистете `src/app/page.tsx` от излишния начален код, оставяйки само основната структура.
